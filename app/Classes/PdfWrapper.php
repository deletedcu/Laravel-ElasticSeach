...
class PdfWrapper{
    ...
    public function AddPage($orientation, $m_left, $m_right, $m_top, $m_bottom, $m_header, $m_footer, $sheet="A4") {
        $this->mpdf->AddPage( $orientation, '', '', '', '', $m_left, $m_right, $m_top, $m_bottom, $m_header, $m_footer);
    }
